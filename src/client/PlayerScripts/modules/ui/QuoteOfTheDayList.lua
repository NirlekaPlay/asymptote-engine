...
local QuoteOfTheDays: { Quote } = {
	...
	{
		message = "Gonow isn’t invisible he’s just really small.",
		author = "~Deleted User"
	},
	{
		message = "Sugar dissolves in water so please don’t walk in the rain or i might lose a sweetie like you.",
	...
	{
		message = "Trained professional — please remain behind the lead shielding",
		author = "~Error"
	},
	{
		message = "In the name of electron, proton and neutron. Atom ⚛️🙏",
		author = "~Ueef"
	},
	{
